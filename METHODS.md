...
Run a BWA alignment and use samtools depth to check the depth
    ...
    See the script: BWAandDepth.sh (Below)
    
[BWAandDepth.sh](https://github.com/TroyLaPolice/Gene-Duplication-Origin-in-a-Non-Model-Organism/blob/master/BWAandDepth.sh)
